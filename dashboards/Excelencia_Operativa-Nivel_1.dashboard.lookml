- dashboard: Excelencia_Operativa_Nivel_1
  ...
  - name: Desglose Resultados
    ...
    color_application:
      ...
      options:
        steps: 5
    y_axes: [{label: Número de ejecuciones, orientation: bottom, series: [{axisId: nivel_1_1.Conteo_OK,
            id: nivel_1_1.Conteo_OK, name: OK}, {axisId: nivel_1_1.Conteo_KO_T, id: nivel_1_1.Conteo_KO_T,
            name: KO Técnico}, {axisId: nivel_1_1.Conteo_KO_F, id: nivel_1_1.Conteo_KO_F,
            name: KO Funcional}], showLabels: true, showValues: true, unpinAxis: false,
  ...
  - name: Sistema
    ...
    model: modelo_vodafone
    explore: nivel_1_1
    listens_to_filters: [Intervalo fecha, Tipo cliente]
    field: system.namet
