view: operation {
  ...
  dimension: namet {
    ...
    link: {
      ...
      url: "https://minsait.eu.looker.com/dashboards/20?Operación={{value}}&date={{_filters['nivel_1_1.fecha'] | url_encode }}&Tipo%20cliente={{ _filters['client_type.namet'] | url_encode }}&Sistema={{ _filters['system.namet'] | url_encode }}"
